...
<div class="homeBtn">
    <a style="all:unset; cursor:pointer"  href="/feed">
        <i class="fa-solid fa-house rgtext"></i>
    </a>
...
<div class="panelItems">
    ...
    <div class="profileContainer">
        <div class="pfp" style="border-radius: 50%; width:150px; height: 150px;">
            <img style="border-radius: 50%; width:150px; height: 150px;" src={data.user.avatar? getImageURL(data.user?.collectionId, data.user?.id, data.user?.avatar):'https://ui-avatars.com/api/?name=$'+ data.user.name} alt="">
        </div>
    </div>
    ...
    <div class="menuContainer">
        ...
        <div class="menuOpts">
            ...
            <ul> 
                <li class="{$page.url.pathname == "/feed/profile/"+ data.user.username ? 'active' : ''}"> <i class="fa-regular fa-id-badge rgtext"></i> 
                    <span>
                    <a style="all:unset; cursor:pointer;" href="/feed/profile/{data.user.username}"> Profile</a>
                
                    </span></li>
                <li class="{$page.url.pathname == "/feed/inbox" ? 'active' : ''}"> <i class="fa-solid fa-inbox rgtext"></i> 
                    <span>
                    <a style="all:unset; cursor:pointer;" href="/feed/inbox"> Inbox </a>
                
                    </span></li>
                <li class="{$page.url.pathname == "/feed/friends" ? 'active' : ''}"> <i class="fa-solid fa-user-group rgtext"></i> 
                    <span>
                    <a style="all:unset; cursor:pointer;" href="/feed/friends">Friends</a>
                
                    </span></li>
                <li class="{$page.url.pathname == "/feed/trending" ? 'active' : ''}"> <i class="fa-solid fa-hashtag rgtext"></i> 
                    <span>
