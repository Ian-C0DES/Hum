...
<script>
    ...
    const res = await fetch(PUBLIC_VITE_POCKETBASE_URL+"/api/collections/message_comments/records?filter=(message='"+messageid+"')&expand=comment,comment.user");
    ...
    <div class="message">
                            ...
                            <div class="messageAuthor">
                                ...
                                <a
                                    ...
                                    href={'/feed/profile/' + data.expand?.user?.username}
                                >
                                    <div class="handle">@{data.expand?.user?.username}</div>
                                </a>
                                <div class="time"><i class="fa-solid fa-clock-rotate-left rgtext"></i> {timeSince(new Date(data.created))} ago</div>
                            </div>
						...
						<div class="commentsWrapper {expandComments? "collapsible":"collapsed"}">
							...
							<div class="commentsContainer" 	in:fly={{duration: 1000, y: -50}}
							...
							<!-- {console.log(item)} -->
								...
								<div class="comment">
									<div class="actionsContainer">
										...
										<button form="commentForm{item.id}" formaction="?/dislikecomment" class="likebtn liked">
									...
									<div class="messageAuthor">
										...
										<div class="time"><i class="fa-solid fa-clock-rotate-left rgtext"></i> {timeSince(new Date(item.created))} ago</div>
									</div>
									<div class="messageContent">
										{item.text}
									</div>
