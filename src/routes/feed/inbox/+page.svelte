                    ...
                    <div class="messagePreview">
                        <span>
                            <span style="font-weight: 900;" class="rgtext">
                                {(openDMS[friend?.username]?.messages[(Object.keys(openDMS[friend?.username]?.messages).length)-1].author==data.user.username? "You":friend?.username)} :
                            </span>
                            {openDMS[friend?.username]?.messages[(Object.keys(openDMS[friend?.username]?.messages).length)-1]?.message}
                        </span>
                        <div class="icon">
              
                            {#if openDMS[friend?.username]?.messages[(Object.keys(openDMS[friend?.username]?.messages).length)-1].author == data.user.username}
                            <i class="fa-solid fa-envelope-circle-check rgtext"></i>
                            {:else if openUsercard?.username == friend?.username }
                            <i class="fa-solid fa-envelope-open rgtext"></i>
                            {:else if openDMS[friend?.username]?.messages[(Object.keys(openDMS[friend?.username]?.messages).length)-1].author == friend?.username}
                            <i class="fa-solid fa-envelope rgtext"></i>
                            <!-- {:else if openUsercard?.username == friend?.username } -->
