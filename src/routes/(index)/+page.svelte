...
<body>
    <div class="navtab">
        ...
        <nav>
            <a href="/">Home</a>
            <a href="/#download">Download <i class="fa-solid fa-arrow-turn-up" style="text-align:start"></i></a>
...
.imagemask{
    ...
    // z-index: 1;
    box-shadow: inset 0px 0px 50px 150px rgba(0,0,0,.9);
    filter: blur(35px);
...
.input-wrapper {
  ...
  width: 80%;
  font-weight: 900;
  color: rgba($color: #000000, $alpha: .30);
  > input,
  > .placeholder {
    display: block;
    appearance: none;
