	...
	<div class="card">
		...
		<div class="container">
			<div class="popupContainer">
				...
				<a href="https://www.iandowlatkhah.com" target="_blank" class="popup"><i class="fa-solid fa-earth-americas"></i></a>
...
.card::before{
  ...
  width:100%;
  height:100%;
  background:linear-gradient(rgba(0, 0, 0,.5), rgba(149, 144, 144,.5));
