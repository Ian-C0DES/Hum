...
<div class="registerContent">
    ...
    <form method="POST">
        ...
        <div class="learnIcon">
            <a href="#opening"><p><i class="fa-solid fa-down-long"></i> Learn More</p></a>
        </div>
    </form>
</div>
</div>
...
<div class="license">
    ...
    <p>
        illistrations rendered with the help of <a href="https://openai.com/api/policies/sharing-publication/">DALL-E, by OpenAI </a>
    </p>
</div>
